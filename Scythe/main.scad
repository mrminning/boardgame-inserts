...
module playerBox() {
  ...
  color("blue")
    tokenBox(size=[player_box_width, player_box_length, player_box_height], hexBottom=no_hex, corner=3, containersX=[33]);
  color("blue")
...
module dialsCardsBox() {
  tokenBox(size=[228, 181, 18], hexBottom=no_hex, corner=3, containersX=[75]);
